...
(cl:defmethod cl:initialize-instance :after ((m <MotorFreqs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorFreqs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pimouse_ros-msg:<MotorFreqs> is deprecated: use pimouse_ros-msg:MotorFreqs instead.")))

(cl:ensure-generic-function 'left_hz-val :lambda-list '(m))
(cl:defmethod left_hz-val ((m <MotorFreqs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pimouse_ros-msg:left_hz-val is deprecated.  Use pimouse_ros-msg:left_hz instead.")
  (left_hz m))

(cl:ensure-generic-function 'right_hz-val :lambda-list '(m))
(cl:defmethod right_hz-val ((m <MotorFreqs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pimouse_ros-msg:right_hz-val is deprecated.  Use pimouse_ros-msg:right_hz instead.")
  (right_hz m))
