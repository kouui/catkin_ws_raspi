...
(cl:defmethod cl:initialize-instance :after ((m <MusicGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MusicGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pimouse_ros-msg:<MusicGoal> is deprecated: use pimouse_ros-msg:MusicGoal instead.")))

(cl:ensure-generic-function 'freqs-val :lambda-list '(m))
(cl:defmethod freqs-val ((m <MusicGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pimouse_ros-msg:freqs-val is deprecated.  Use pimouse_ros-msg:freqs instead.")
  (freqs m))

(cl:ensure-generic-function 'durations-val :lambda-list '(m))
(cl:defmethod durations-val ((m <MusicGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pimouse_ros-msg:durations-val is deprecated.  Use pimouse_ros-msg:durations instead.")
  (durations m))
