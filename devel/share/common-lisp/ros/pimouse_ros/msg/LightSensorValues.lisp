...
(cl:defmethod cl:initialize-instance :after ((m <LightSensorValues>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LightSensorValues)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pimouse_ros-msg:<LightSensorValues> is deprecated: use pimouse_ros-msg:LightSensorValues instead.")))

(cl:ensure-generic-function 'right_forward-val :lambda-list '(m))
(cl:defmethod right_forward-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pimouse_ros-msg:right_forward-val is deprecated.  Use pimouse_ros-msg:right_forward instead.")
  (right_forward m))

(cl:ensure-generic-function 'right_side-val :lambda-list '(m))
(cl:defmethod right_side-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pimouse_ros-msg:right_side-val is deprecated.  Use pimouse_ros-msg:right_side instead.")
  (right_side m))

(cl:ensure-generic-function 'left_side-val :lambda-list '(m))
(cl:defmethod left_side-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pimouse_ros-msg:left_side-val is deprecated.  Use pimouse_ros-msg:left_side instead.")
  (left_side m))

(cl:ensure-generic-function 'left_forward-val :lambda-list '(m))
(cl:defmethod left_forward-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pimouse_ros-msg:left_forward-val is deprecated.  Use pimouse_ros-msg:left_forward instead.")
  (left_forward m))

(cl:ensure-generic-function 'sum_all-val :lambda-list '(m))
(cl:defmethod sum_all-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pimouse_ros-msg:sum_all-val is deprecated.  Use pimouse_ros-msg:sum_all instead.")
  (sum_all m))

(cl:ensure-generic-function 'sum_forward-val :lambda-list '(m))
(cl:defmethod sum_forward-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pimouse_ros-msg:sum_forward-val is deprecated.  Use pimouse_ros-msg:sum_forward instead.")
  (sum_forward m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <LightSensorValues>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'sum_all)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 65536) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    )
  (cl:let* ((signed (cl:slot-value msg 'sum_forward)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 65536) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    )
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LightSensorValues>) istream)
  "Deserializes a message object of type '<LightSensorValues>"
    ...
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'sum_all) (cl:if (cl:< unsigned 32768) unsigned (cl:- unsigned 65536))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'sum_forward) (cl:if (cl:< unsigned 32768) unsigned (cl:- unsigned 65536))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LightSensorValues>)))
  ...
  "c174e6891a013b1ba6a929fcc020e0a3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LightSensorValues)))
  "Returns md5sum for a message object of type 'LightSensorValues"
  "c174e6891a013b1ba6a929fcc020e0a3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LightSensorValues>)))
  ...
  (cl:format cl:nil "int16 right_forward~%int16 right_side~%int16 left_side~%int16 left_forward~%int16 sum_all~%int16 sum_forward~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LightSensorValues)))
  "Returns full string definition for message of type 'LightSensorValues"
  (cl:format cl:nil "int16 right_forward~%int16 right_side~%int16 left_side~%int16 left_forward~%int16 sum_all~%int16 sum_forward~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <LightSensorValues>))
  ...
  (cl:list 'LightSensorValues
    ...
    (cl:cons ':sum_all (sum_all msg))
    (cl:cons ':sum_forward (sum_forward msg))
))
