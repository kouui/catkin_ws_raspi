...
(cl:defmethod cl:initialize-instance :after ((m <TimedMotion-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimedMotion-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name raspimouse_ros_2-srv:<TimedMotion-request> is deprecated: use raspimouse_ros_2-srv:TimedMotion-request instead.")))

(cl:ensure-generic-function 'left_hz-val :lambda-list '(m))
(cl:defmethod left_hz-val ((m <TimedMotion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raspimouse_ros_2-srv:left_hz-val is deprecated.  Use raspimouse_ros_2-srv:left_hz instead.")
  (left_hz m))

(cl:ensure-generic-function 'right_hz-val :lambda-list '(m))
(cl:defmethod right_hz-val ((m <TimedMotion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raspimouse_ros_2-srv:right_hz-val is deprecated.  Use raspimouse_ros_2-srv:right_hz instead.")
  (right_hz m))

(cl:ensure-generic-function 'duration_ms-val :lambda-list '(m))
(cl:defmethod duration_ms-val ((m <TimedMotion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raspimouse_ros_2-srv:duration_ms-val is deprecated.  Use raspimouse_ros_2-srv:duration_ms instead.")
  (duration_ms m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TimedMotion-request>)))
  ...
  "raspimouse_ros_2/TimedMotionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TimedMotion-request)))
  "Returns string type for a service object of type 'TimedMotion-request"
  "raspimouse_ros_2/TimedMotionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TimedMotion-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimedMotion-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name raspimouse_ros_2-srv:<TimedMotion-response> is deprecated: use raspimouse_ros_2-srv:TimedMotion-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <TimedMotion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raspimouse_ros_2-srv:success-val is deprecated.  Use raspimouse_ros_2-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TimedMotion-response>)))
  ...
  "raspimouse_ros_2/TimedMotionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TimedMotion-response)))
  "Returns string type for a service object of type 'TimedMotion-response"
  "raspimouse_ros_2/TimedMotionResponse")
