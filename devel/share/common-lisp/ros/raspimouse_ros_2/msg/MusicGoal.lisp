...
(cl:defmethod cl:initialize-instance :after ((m <MusicGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MusicGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name raspimouse_ros_2-msg:<MusicGoal> is deprecated: use raspimouse_ros_2-msg:MusicGoal instead.")))

(cl:ensure-generic-function 'freqs-val :lambda-list '(m))
(cl:defmethod freqs-val ((m <MusicGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raspimouse_ros_2-msg:freqs-val is deprecated.  Use raspimouse_ros_2-msg:freqs instead.")
  (freqs m))

(cl:ensure-generic-function 'durations-val :lambda-list '(m))
(cl:defmethod durations-val ((m <MusicGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raspimouse_ros_2-msg:durations-val is deprecated.  Use raspimouse_ros_2-msg:durations instead.")
  (durations m))
