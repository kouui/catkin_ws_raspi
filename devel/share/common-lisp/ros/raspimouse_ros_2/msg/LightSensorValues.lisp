...
(cl:defmethod cl:initialize-instance :after ((m <LightSensorValues>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LightSensorValues)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name raspimouse_ros_2-msg:<LightSensorValues> is deprecated: use raspimouse_ros_2-msg:LightSensorValues instead.")))
...
(cl:defmethod sum_all-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raspimouse_ros_2-msg:sum_all-val is deprecated.  Use raspimouse_ros_2-msg:sum_all instead.")
  (sum_all m))

(cl:ensure-generic-function 'sum_forward-val :lambda-list '(m))
(cl:defmethod sum_forward-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader raspimouse_ros_2-msg:sum_forward-val is deprecated.  Use raspimouse_ros_2-msg:sum_forward instead.")
  (sum_forward m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LightSensorValues>)))
  ...
  "raspimouse_ros_2/LightSensorValues")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LightSensorValues)))
  "Returns string type for a message object of type 'LightSensorValues"
  "raspimouse_ros_2/LightSensorValues")
